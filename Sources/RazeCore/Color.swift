...
extension RazeCore {
    ...
    public class Color {
        ...
        /// - Parameters:
        ///   - hexString: A 6-deigit hexadecimal string. Use 6 digits rather than 8 and add the accompanying alpha value in the next parameter
        ...
        /// Returns the second most pleasing color in an UIColor object
